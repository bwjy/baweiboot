package com.bawei.bwboot.common.base;

import com.bawei.bwboot.common.enums.response.base.CommonResponseEnum;
import com.bawei.bwboot.common.token.user.ActionEnum;
import com.bawei.bwboot.common.token.user.TokenVerify;
import com.bawei.bwboot.common.token.user.UserTokenHandler;
...
public class RequestAspect {
    ...
    @Pointcut("execution(public java.util.Map com.bawei.bwboot.controller..*.*(..))")
